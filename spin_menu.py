...
def page_opener(page_prompt, page_screen):
...
def main_menu(menu_displ):
    ...
    settinsButton = Button.button_maker("settings", menu_displ, (mds_x-60, mds_y-60), (50, 50))
    playButton = Button.button_maker("play", menu_displ, (mds_x/2 - 80, mds_y/2 - 50), (80, 50))
    customButton = Button.button_maker("custom play", menu_displ, (mds_x/2 + 80, mds_y/2 - 50), (80, 50))
    menu_running = True
